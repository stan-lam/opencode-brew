...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::github::github_pull_request_diff,
            commands::gitlab::gitlab_list_merge_requests,
            commands::gitlab::gitlab_merge_request_diff,
            ...
            commands::ai::copilot_list_accounts,
            commands::ai::copilot_import_account,
            commands::ai::copilot_cached_accounts_list,
            commands::ai::copilot_cached_account_import,
            commands::ai::copilot_cached_accounts_clear,
            commands::ai::copilot_cached_models_list,
            commands::ai::copilot_device_logout,
            commands::ai::copilot_oauth_start,
            commands::ai::copilot_oauth_poll,
            ...
            commands::window::open_tool_window,
            commands::window::close_tool_window,
            ...
            // Notes commands
            commands::notes::init_notes_db,
            commands::notes::list_workspaces,
            commands::notes::create_workspace,
            commands::notes::update_workspace,
            commands::notes::delete_workspace,
            commands::notes::list_folders,
            commands::notes::create_folder,
            commands::notes::update_folder,
            commands::notes::delete_folder,
            commands::notes::list_conversations,
            commands::notes::create_conversation,
            commands::notes::update_conversation,
            commands::notes::delete_conversation,
            commands::notes::list_messages,
            commands::notes::add_message,
            commands::notes::update_message_content,
            commands::notes::list_tags,
            commands::notes::create_tag,
            commands::notes::delete_tag,
            commands::notes::add_tag_to_conversation,
            commands::notes::remove_tag_from_conversation,
            ...
            commands::scheduler::create_agent,
            commands::scheduler::update_agent,
